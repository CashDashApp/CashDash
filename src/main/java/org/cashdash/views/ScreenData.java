...
public class ScreenData {
    ...
    public static DefaultTableModel Print_Bill = new DefaultTableModel(null,new String [] {"ID", "Product", "Harga", "Jumlah", "Total"});    
    ...
    public void add_PrintBill(String IDPesanan, String LabelProduk, String LabelHarga, int JumlahPesanan,int Total){
        Print_Bill.addRow(new Object[] {IDPesanan,LabelProduk, LabelHarga, JumlahPesanan, Total});
        Print_Bill.fireTableDataChanged();
    }
    
    public void add_Transaction(String IDTransaksi, String Cashier, String Customer, String No_Telp, double Harga, String Date){
        if(Transaction_Panel.getRowCount() == 0){
            for(Transaction trs: ObjTransaction){
                ...
                Transaction_Panel.fireTableDataChanged();
            }
        }
    }
